...
* @Service - It is a specialization of the component annotation. It currently 
* provide any additional behavior over the @Component annotation, but a good idea 
...
public class ReminderServiceImpl implements ReminderService {
	...
	public void ReminderServiceImpl(ReminderDAO reminderDAO) {
	...
	public Reminder updateReminder(Reminder reminder, int id) throws ReminderNotFoundException {
		...
		Reminder newReminder = reminderDAO.getReminderById(id);
		if(newReminder==null)
